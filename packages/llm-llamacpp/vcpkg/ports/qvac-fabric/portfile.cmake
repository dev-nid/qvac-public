...
# Android & Linux: always build CPU variants (NEON_DOTPROD, NEON_I8MM, etc.
# on arm64; SSE4.2/AVX/AVX2/AVX512 on x64) and CPU repacking. These are
# CPU-only runtime optimizations selected based on the host's SIMD
# capabilities at load time, completely orthogonal to the GPU backends.
# Bundling them is essential for good CPU inference performance across the
# wide range of arm64 devices and x86_64 desktop CPUs the addons ship to.
# Requires GGML_BACKEND_DL to dispatch the variants at runtime; the existing
# #ifdef guard around `ggml_backend_load_all_from_path()` in
# ggml-backend-reg.cpp keeps the search scoped to the consumer's own
# prebuilds dir. macOS/iOS keep static linkage because Metal is statically
# linked into ggml itself and there are no CPU SIMD variants to dispatch.
